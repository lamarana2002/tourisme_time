...
import 'package:tourisme_time/screens/camera/camera_details.dart';
...
class _CameraItemState extends State<CameraItem> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>CameraDetails(camera: widget.camera)));
        },
        child: Stack(
          children: [
            Image.asset(
